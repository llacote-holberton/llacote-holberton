# Technical Product Owner & IT Project Manager [🇬🇧](#)[🇫🇷](README_FR.md)


## Me in a nutshell
- Core values: collaboration, thoroughness, curiosity, sharing, honesty.
- Top Skills: planning, research, analysis
- Cravings: learning new things, crafting tools to improve daily lives, delivering quality
- Main know-how areas: web development, targeted documentation, application design, free software ecosystem.
- Languages: 
...
TL;DR: While my academic background was not tightly associated with information technologies, I have always bathed in that culture, learning Linux sysadmin and development basics by myself to improve my personal use of computers. I took the opportunity to work for a French Free Software Editor to bootstrap a career anchored in the free software ecosystem and help it as it helped me.  

The open-ended position's scopes allowed me to nurtur this multi-faceted profile mixing technical and non-technical skills over years, to contribute to internal/external IT projects in various way beyond the core webmastering or project management tasks.  

As I want to lean more on the "technical side" of my profile in my future positions, I took the opportunity of a mission ended to engage into a Web Development training (currently ongoing)...  
To consolidate and expand the technical know-hows I acquired in the field over the years and become a better tech team leader / IT project manager.
...
Although I really enjoy(ed) having different, complementary roles to lead projects, what I felt missing was a rock-solid knowledge and know-how in actual development...
As I rarely got the chance to directly contribute code myself beyond minor bugfixes/evolutions, tests or automation scripts.

The main exception was my work at French Ministry of Finances in which I was required to engage through and through (including writing proof of concepts myself to challenge architecture choices), which confirmed my appetite for "getting my hands dirty".
...
However if you want someone immediately up to the task, here are the limits framing the aforementioned list, in which context you may prefer someone more specialized or more experienced: Infrastructure-level consulting, high-availability or high-performance applications, advanced cybersecurity audit and practices. 


### What am I looking for?

My combined experience enables me to provide a cross-section view on any project: from the high-level picture (business goals, main externalities, roadmap's milestones) to the daily execution hurdles (dev unavailability, security flaws reported in library, new feature challenging current architecture) which may jam the whole project or snowball into huge crisis if left alone.

As such, I am drawn to roles where the lines between requirement analysis, architecture input and hands-on project leadership are deliberately blurred — with more emphasis on shipping and team dynamics than on budget cycles. Ideally on open source or public-interest projects where the 'why' matters as much as the 'how'.
